...
int main(){
    ...
    // Create fifo file
    negative_one_error_handler(mkfifo(FIFO_FILE_PATH, FIFO_FILE_MODE), "Unable to create fifo file", exit);
    ...
    while(1){
        ...
        reciving_buffer[read_user_input_bytes] = '\0'; // Pseudo-clearing the buffer
